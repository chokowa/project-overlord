...
export const BOSS_WAVES = {
    ...
    2: { name: "SHADOW STALKER", color: "#34495e", scale: 1.5, hp: 12.0, speed: 1.2, count: 1 }, // Speed 1.5 -> 1.2
    3: { name: "IRON GOLEM", color: "#95a5a6", scale: 3.0, hp: 30.0, speed: 0.3, count: 1 },

    // Wave 4+: Challenge begins (Linear Scaling)
    4: { name: "TWIN FANGS", color: "#e67e22", scale: 1.8, hp: 45.0, speed: 1.3, count: 2 },
    5: { name: "HIVE MOTHER", color: "#9b59b6", scale: 3.5, hp: 80.0, speed: 0.2, count: 1 },
    6: { name: "CRIMSON & AZURE", color: "#e74c3c", scale: 2.0, hp: 60.0, speed: 0.9, count: 2 },
    7: { name: "CHAOS KNIGHT", color: "#f1c40f", scale: 2.2, hp: 120.0, speed: 1.0, count: 1 },
    8: { name: "THE TRIAD", color: "#bdc3c7", scale: 1.6, hp: 80.0, speed: 1.1, count: 3 },
    9: { name: "VOID DRAGON", color: "#8e44ad", scale: 4.0, hp: 300.0, speed: 0.6, count: 1 },
    10: { name: "OVERLORD", color: "#c0392b", scale: 5.0, hp: 1000.0, speed: 0.5, count: 1 } // 10000 -> 1000 (still tanky but beatable)
};
...
export const SKILL_TREE_NODES = {
    ...
    100: {
        id: 100, name: "System Hacker", label: "システムハッカー", type: "KEYSTONE", x: 1000, y: 350, maxRank: 1,
    ...
    200: {
        id: 200, name: "Fortress Protocol", label: "フォートレス・プロトコル", type: "KEYSTONE", x: 1000, y: 1150, maxRank: 1,
    ...
    300: {
        id: 300, name: "Drone Orchestrator", label: "ドローン統制", type: "KEYSTONE", x: 1400, y: 750, maxRank: 1,
    ...
    400: {
        id: 400, name: "Arc Reactor", label: "アーク炉心", type: "KEYSTONE", x: 600, y: 750, maxRank: 1,
