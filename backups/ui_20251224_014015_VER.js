...
export function updateCrewHud() {
    ...
    if (!container) {
        ...
        // [Patch] Position optimized for Sci-Fi Cockpit HUD (Starts above Quick Buy buttons)
        // HUD(140px) + QuickBuy(40px) + Spacing = approx 200px required
        container.style.cssText = "position:absolute; bottom:calc(220px + env(safe-area-inset-bottom)); right:10px; display:flex; flex-direction:column; gap:10px; z-index:45;";
