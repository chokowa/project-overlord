...
export const GAME_SETTINGS = {
    ...
    DROP_CHANCE: 0.3,       
    CASTLE_Y: 800,      
    CASTLE_DAMAGE: 10, // ダメージを少し緩和（戦闘時間が伸びるため）
...
export const BOSS_WAVES = {
    ...
    9: { name: "VOID DRAGON", color: "#8e44ad", scale: 3.5, hp: 150.0, speed: 0.7, count: 1 }, // Sub-Boss (Buffed)
    10: { name: "OVERLORD", color: "#c0392b", scale: 4.0, hp: 6000.0, speed: 0.6, count: 1 } // Final Boss (30x HP)
};
...
export const ENEMY_TIERS = {
    // [Patch] User requested balance: Normal(1hit) : Magic(3hits) : Rare(8hits)
    NORMAL: { id: 'NORMAL', name: 'Normal', color: '#e74c3c', scale: 1.0, hpMod: 1.0, xpMod: 1.2, speedMod: 0.9, chance: 0.70 },
    MAGIC: { id: 'MAGIC', name: 'Magic', color: '#3498db', scale: 1.25, hpMod: 3.0, xpMod: 4.0, speedMod: 1.0, chance: 0.20 },
    RARE: { id: 'RARE', name: 'Rare', color: '#f1c40f', scale: 1.5, hpMod: 8.0, xpMod: 15.0, speedMod: 1.2, chance: 0.08 },
    BOSS: { id: 'BOSS', name: 'Boss', color: '#8e44ad', scale: 2.2, hpMod: 100.0, xpMod: 100.0, speedMod: 0.5, chance: 0.02 }
};
