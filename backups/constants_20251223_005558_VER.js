...
export const CREW_DATA = {
    1: { id: 1, name: "Cmdr. Wolf", job: "司令官",   desc: "全ダメージ +20%", stats: { damage_pct: 0.20 }, imgBase: "Character/1" },
    2: { id: 2, name: "Pilot Luna", job: "操縦士",   desc: "攻撃速度 +20%",   stats: { rate_pct: 0.20 },   imgBase: "Character/2" },
    3: { id: 3, name: "Eng. R-22",  job: "技師ロボ", desc: "クリティカル率 +10% / 範囲 +15%", stats: { crit_chance: 0.10, aoe_pct: 0.15 }, imgBase: "Character/3" },
    4: { id: 4, name: "Dr. Xeno",   job: "科学者",   desc: "被ダメージ -15% / HP自然回復",   stats: { damage_reduction: 0.15, hp_regen: 2 }, imgBase: "Character/4" },
    5: { id: 5, name: "Trader Mida",job: "闇商人",   desc: "Gold/XP獲得 +30%", stats: { gold_gain: 0.30, xp_gain: 0.30 }, imgBase: "Character/5" }
};
