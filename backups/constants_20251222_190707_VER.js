...
export const SKILL_TREE_NODES = {
    ...
    // KEYSTONE: ARC REACTOR
    400: { id: 400, name: "Arc Reactor", label: "アーク炉心", type: "KEYSTONE", x: 600, y: 750, maxRank: 1,
           description: "クリティカル率が0になる代わりに、範囲 +30% / 連鎖範囲 +30% / 最終ダメージ x1.2",
           stats: { crit_chance: -10.0, aoe_pct: 0.30, chain_range_pct: 0.30, final_damage_mul: 1.2 }, connections: [] }
};
