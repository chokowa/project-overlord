...
export function refreshInventoryInterface() {
    // 画面更新時はツールチップを確実に消す（要素削除でmouseleaveが発火しないため）
    ...
    sortedInv.forEach(item => {
        ...
        // Background Tint & Border based on Type Category (Unified for clarity)
        // Active = Red-ish, Support = Green-ish
        if (item.type === 'ACTIVE') {
