...
export const GAME_SETTINGS = {
    ...
    CASTLE_DAMAGE: 15   // 城壁へのダメージ量 (Patch-08で追加)
};
...
/** * ステージ構成（ハクスラ進行用）
 * @type {Array<{level: number, name: string, waveCount: number, enemyScale: number}>}
 */
