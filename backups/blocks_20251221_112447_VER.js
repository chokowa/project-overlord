...
/** * 現在のワークスペースからコードを生成し、ゲームエンジンに適用する
 */
...
window.addEventListener('load', () => {
    ...
    try {
        Blockly.Xml.domToWorkspace(Blockly.Xml.textToDom(initialXml), mainWorkspace);
    } catch (xmlError) {
