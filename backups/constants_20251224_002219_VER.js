...
export const BOSS_ARTIFACTS = {
    ...
    // --- Crew Exclusive Artifacts ---
    WOLF_INSIGNIA:  { id: 'wolf_insignia',  name: '司令官の誇り', icon: '🎖️', desc: 'ドローン/分身威力+50%', type: 'BOSS_ARTIFACT', color: '#d63031', requiredCrewId: 1 },
    LUNA_WING:      { id: 'luna_wing',      name: '月白の翼', icon: '🕊️', desc: '弾速に応じてダメージUP', type: 'BOSS_ARTIFACT', color: '#81ecec', requiredCrewId: 2 },
    R22_WRENCH:     { id: 'r22_wrench',     name: '黄金のレンチ', icon: '🔧', desc: 'シールド回復速度2倍', type: 'BOSS_ARTIFACT', color: '#ffeaa7', requiredCrewId: 3 },
    XENO_FLASK:     { id: 'xeno_flask',     name: '禁断の試薬', icon: '🧪', desc: '毒の持続時間が2倍', type: 'BOSS_ARTIFACT', color: '#a29bfe', requiredCrewId: 4 },
    MIDAS_COIN:     { id: 'midas_coin',     name: 'ミダスの金貨', icon: '🟡', desc: '被弾時 10G失う代わりに無効', type: 'BOSS_ARTIFACT', color: '#fdcb6e', requiredCrewId: 5 }
};
