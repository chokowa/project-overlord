...
export const ENEMY_TIERS = {
    // HP Modulus massively increased to encourage combos/synergy
    NORMAL: { id: 'NORMAL', name: 'Normal', color: '#e74c3c', scale: 1.0, hpMod: 4.0, xpMod: 1.2, speedMod: 0.9, chance: 0.70 },
    MAGIC: { id: 'MAGIC', name: 'Magic', color: '#3498db', scale: 1.25, hpMod: 12.0, xpMod: 4.0, speedMod: 1.0, chance: 0.20 },
    RARE: { id: 'RARE', name: 'Rare', color: '#f1c40f', scale: 1.5, hpMod: 30.0, xpMod: 15.0, speedMod: 1.2, chance: 0.08 },
    BOSS: { id: 'BOSS', name: 'Boss', color: '#8e44ad', scale: 2.2, hpMod: 150.0, xpMod: 100.0, speedMod: 0.5, chance: 0.02 }
};
