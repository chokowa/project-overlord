...
/* =========================================
   ULTIMATE CONFIG MANAGER (Moved from game.js)
   ========================================= */
...
class ConfigManager {
    ...
    init() {
        ...
        // 3. Create UI
        this.createUI();
        console.log("Ultimate ConfigManager V3 Initialized (UI Module)");
    }
    ...
    save() {
        ...
        // Use showToast instead of FloatingText for clean dependency
        if (window.showToast) window.showToast("CONFIG SAVED!", "#2ecc71");
    }
    ...
    createUI() {
        ...
        // Debug/Config Button (Hidden by default, enable via console or flag)
        const SHOW_CONFIG_BUTTON = false; 
