...
export function updateCrewHud() {
    ...
    if (!container) {
        ...
        // 画面右下、シールドオーブの左上あたりに配置
        container.style.cssText = "position:absolute; bottom:150px; right:10px; display:flex; flex-direction:column; gap:10px; pointer-events:none; z-index:45;";
