...
export const SKILL_TREE_NODES = {
    ...
    11: { id: 11, name: "Damage II", type: "SMALL", x: 1000, y: 550, stats: { damage_pct: 0.15 }, connections: [100, 12, 13] },
    12: { id: 12, name: "Crit Rate I", type: "SMALL", x: 900, y: 500, stats: { crit_chance: 0.05 }, connections: [] },
    13: { id: 13, name: "Blast Radius", type: "SMALL", x: 1100, y: 500, description: "AOE範囲 +25%", stats: { aoe_pct: 0.25 }, connections: [] },
    ...
    31: { id: 31, name: "Speed II", type: "SMALL", x: 1200, y: 950, stats: { rate_pct: 0.15 }, connections: [300, 32, 33] },
    32: { id: 32, name: "Proj Speed", type: "SMALL", x: 1300, y: 950, stats: { proj_speed_pct: 0.2 }, connections: [] },
    33: { id: 33, name: "Arcane Link", type: "SMALL", x: 1300, y: 850, description: "連鎖感知距離 +30%", stats: { chain_range_pct: 0.3 }, connections: [] },
