...
export const SKILL_TREE_NODES = {
    // --- CENTER: ORIGIN ---
    0: { id: 0, name: "Core System", type: "START", x: 1000, y: 750, maxRank: 1, stats: {}, connections: [1, 2, 3, 4] },

    // --- NORTH: POWER (Red) ---
    1: { id: 1, name: "Brute Force", type: "SMALL", x: 1000, y: 650, maxRank: 5, description: "ダメージ +5%/Lv", stats: { damage_pct: 0.05 }, connections: [11, 12] },
    11: { id: 11, name: "Deadly Aim", type: "SMALL", x: 920, y: 550, maxRank: 5, description: "クリティカル率 +3%/Lv", stats: { crit_chance: 0.03 }, connections: [13] },
    12: { id: 12, name: "Heavy Impact", type: "SMALL", x: 1080, y: 550, maxRank: 5, description: "クリティカル倍率 +15%/Lv", stats: { crit_damage: 0.15 }, connections: [13] },
    13: { id: 13, name: "Executioner", type: "MEDIUM", x: 1000, y: 450, maxRank: 3, description: "ダメージ +8%, クリティカル率 +2%", stats: { damage_pct: 0.08, crit_chance: 0.02 }, connections: [100] },

    // KEYSTONE: BLOOD RITE (High Risk, High Return)
    100: { id: 100, name: "Blood Rite", type: "KEYSTONE", x: 1000, y: 350, maxRank: 1,
    ...
    2: { id: 2, name: "Reinforced Hull", type: "SMALL", x: 1000, y: 850, maxRank: 5, description: "最大HP +150/Lv", stats: { hp_max: 150 }, connections: [21, 22] },
    21: { id: 21, name: "Scavenger", type: "SMALL", x: 920, y: 950, maxRank: 5, description: "Gold/XP獲得 +6%/Lv", stats: { xp_gain: 0.06, gold_gain: 0.06 }, connections: [23] },
    22: { id: 22, name: "Nano Repair", type: "SMALL", x: 1080, y: 950, maxRank: 3, description: "Hit時HP回復 +2/Lv", stats: { life_on_hit: 2 }, connections: [23] },
    23: { id: 23, name: "Fortify", type: "MEDIUM", x: 1000, y: 1050, maxRank: 3, description: "被ダメージ -4%/Lv", stats: { damage_reduction: 0.04 }, connections: [200] },

    // KEYSTONE: IRON FORTRESS (Super Tank)
    200: { id: 200, name: "Iron Fortress", type: "KEYSTONE", x: 1000, y: 1150, maxRank: 1,
    ...
    3: { id: 3, name: "Rapid Fire", type: "SMALL", x: 1100, y: 750, maxRank: 5, description: "攻撃速度 +5%/Lv", stats: { rate_pct: 0.05 }, connections: [31, 32] },
    31: { id: 31, name: "Ballistics", type: "SMALL", x: 1200, y: 680, maxRank: 5, description: "弾速 +10%/Lv", stats: { proj_speed_pct: 0.10 }, connections: [33] },
    32: { id: 32, name: "Multitask", type: "SMALL", x: 1200, y: 820, maxRank: 3, description: "サポート効果 +5%/Lv", stats: { support_effect: 0.05 }, connections: [33] },
    33: { id: 33, name: "Network", type: "MEDIUM", x: 1300, y: 750, maxRank: 3, description: "連鎖範囲 +20%, 攻撃速度 +3%", stats: { chain_range_pct: 0.2, rate_pct: 0.03 }, connections: [300] },

    // KEYSTONE: NANOTECH SWARM (Support Master)
    300: { id: 300, name: "Nanotech Swarm", type: "KEYSTONE", x: 1400, y: 750, maxRank: 1,
           description: "サポートGEMレベル+3相当, 本体火力-50%",
           stats: { support_level_bonus: 3, damage_pct: -0.5 }, connections: [] },

    // --- WEST: MAGIC & AOE (Blue) - NEW BRANCH ---
    4: { id: 4, name: "Expansion", type: "SMALL", x: 900, y: 750, maxRank: 5, description: "範囲サイズ +8%/Lv", stats: { aoe_pct: 0.08 }, connections: [41, 42] },
    41: { id: 41, name: "Elemental Focus", type: "SMALL", x: 800, y: 680, maxRank: 5, description: "ダメージ +6%, 範囲 +2%", stats: { damage_pct: 0.06, aoe_pct: 0.02 }, connections: [43] },
    42: { id: 42, name: "Overclock", type: "SMALL", x: 800, y: 820, maxRank: 3, description: "攻撃速度 +4%, 弾速 +5%", stats: { rate_pct: 0.04, proj_speed_pct: 0.05 }, connections: [43] },
    43: { id: 43, name: "Cataclysm", type: "MEDIUM", x: 700, y: 750, maxRank: 3, description: "範囲サイズ +15%, ダメージ +5%", stats: { aoe_pct: 0.15, damage_pct: 0.05 }, connections: [400] },

    // KEYSTONE: ELEMENTAL OVERLOAD (AoE Specialist)
    400: { id: 400, name: "Elemental Overload", type: "KEYSTONE", x: 600, y: 750, maxRank: 1,
