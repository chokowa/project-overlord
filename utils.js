...
const ASSET_PATHS = {
    ...
    ENEMY_ROGUE: 'assets/enemy_rogue.png',
    ENEMY_SWARM: 'assets/enemy_swarm.png',
    ENEMY_MAGIC: 'assets/enemy_magic.png',
    ENEMY_RARE: 'assets/enemy_rare.png',
    ENEMY_AEGIS: 'assets/enemy_aegis.png',

    // Enemies - Bosses
    BOSS_SLIME: 'assets/boss_slime.png',
    BOSS_SHADOW: 'assets/boss_shadow.png',
    BOSS_GOLEM: 'assets/boss_golem.png'
};
